...
public enum ErrorKey {
    ...
    OK("000", "Success"),
    PRODUCT_NOT_FOUND("001", "Not Found"),
    ACCESS_DENIED("002", "Forbidden"),
    INTERNAL_ERROR("003", "Internal error"),
    INVALID_AUTH_HEADER("004", "Bad request"),
    MISSING_AUTH_HEADER("005", "Bad request"),
    INVALID_PARAMETERS("006", "Bad request"),
    X2_ACCOUNT_MISSING_GROUPS("007", "Not Found"),
    ONLY_INVITED_PROJECT("008", "Forbidden"),
    ONCE_PER_PROJECT("009", "Forbidden"),
    COMPONENT_PARAM_NOT_MEET_REGEX("010", "Bad request"),
    INVALID_LOCATION("011", "Bad request"),
    PROJECT_NOT_FOUND("012", "Not Found"),
    COMPONENT_NOT_FOUND("013", "Not Found"),
    BAD_REQUEST_BODY("014", "Bad request"),
    FORBIDDEN("015", "Forbidden"),
